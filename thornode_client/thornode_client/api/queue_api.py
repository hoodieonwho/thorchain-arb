...
class QueueApi(object):
    ...
    def get_outbound_queue(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_outbound_queue(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_outbound_queue_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_outbound_queue_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_outbound_queue_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_outbound_queue_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_outbound_queue" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_outbound_queue_detail(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_outbound_queue_detail_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_outbound_queue_detail_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_outbound_queue_detail_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_outbound_queue_detail" % key
                )
            params[key] = val
        del params['kwargs']
